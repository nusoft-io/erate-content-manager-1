  ...
  try {
    ...
    if (intended_track.length) {
      for (let el of intended_track) {
        ...
        const moduleId = await db.query(moduleIdQuery, [
    ...
    return next({
      ...
      message: {
        err: "moduleController.addModule: ERROR: Check server logs for details",
      },
    });
  }
  return next();
  ...
  try {
    ...
    for (const module of allModules) {
      ...
      for (let el of attachedTracks) {
        AllModInfo.attachedTracks.push({
          track_id: el.track_id,
          track_name: trackMatcherName[el.track_id],
        });
      }
    ...
    return next({
      ...
      message: {
        err: "moduleController.getAllModules: ERROR: Check server logs for details",
      },
    });
  }
  return next();
...
moduleController.deleteModule = async (req, res, next) => {
  try {
    ...
    return next({
      ...
      message: {
        err: "moduleController.deleteModule: ERROR: Check server logs for details",
      },
    });
  }
  return next();
...
moduleController.updateModuleOrder = async (req, res, next) => {
  try {
    ...
    return next({
      ...
      message: {
        err: "moduleController.updateModuleOrder: ERROR: Check server logs for details",
      },
    });
  }
  return next();
...
moduleController.updateVideoLink = async (req, res, next) => {
  try {
    ...
    return next({
      ...
      message: {
        err: "moduleController.updateVideoLink: ERROR: Check server logs for details",
      },
    });
  }
};

moduleController.updateAskCount = async (req, res, next) => {
  try {
    const moduleId = req.body.moduleId;
    const askCount = req.body.ask_count;
    const queryStr = `UPDATE modules SET ask_count = ? WHERE module_id = ?`;
    const VALUES = [askCount, moduleId];
    await db.query(queryStr, VALUES);
    return next();
  } catch (err) {
    return next({
...
moduleController.addQuestion = async (req, res, next) => {
  try {
    ...
    return next({
      ...
      message: {
        err: "moduleController.addQuestion: ERROR: Check server logs for details",
      },
    });
  }
};
...
moduleController.getQuestions = async (req, res, next) => {
  try {
    ...
    return next({
      ...
      message: {
        err: "moduleController.getQuestions: ERROR: Check server logs for details",
      },
    });
  }
  return next();
...
moduleController.deleteQuestions = async (req, res, next) => {
  try {
    ...
    return next({
      ...
      message: {
        err: "moduleController.deleteQuestions: ERROR: Check server logs for details",
      },
    });
  }
};
...
moduleController.getAnswers = async (req, res, next) => {
  try {
    ...
    return next({
      ...
      message: {
        err: "moduleController.getAnswers: ERROR: Check server logs for details",
      },
    });
  }
  return next();
...
moduleController.addToTrack = async (req, res, next) => {
  try {
    ...
    return next({
      ...
      message: {
        err: "moduleController.addToTrack: ERROR: Check server logs for details",
      },
    });
  }
};
